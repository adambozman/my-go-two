...
const BRAND_SEARCH_TEMPLATES: Record<string, (query: string) => string> = {
  ...
  "cerave": (query) => `https://www.cerave.com/search?query=${encodeURIComponent(query)}`,
  "the ordinary": (query) => siteSearch("https://theordinary.com/en-us/search", query),
  "sol de janeiro": (query) => siteSearch("https://soldejaneiro.com/search", query),
  "philips sonicare": (query) => `https://www.usa.philips.com/c-w/search.html#q=${encodeURIComponent(query)}`,
  "uncommon goods": (query) => siteSearch("https://www.uncommongoods.com/search", query),
  "urbanstems": (query) => siteSearch("https://urbanstems.com/search", query),
  "sugarfina": (query) => siteSearch("https://www.sugarfina.com/search", query),
  "etsy": (query) => siteSearch("https://www.etsy.com/search", query),
  "lego": (query) => siteSearch("https://www.lego.com/en-us/search", query),
  "barnes & noble": (query) => siteSearch("https://www.barnesandnoble.com/s/", query),
  "target": (query) => siteSearch("https://www.target.com/s", query),
  "away": (query) => siteSearch("https://www.awaytravel.com/search", query),
  "baggu": (query) => siteSearch("https://www.baggu.com/search", query),
  "calpak": (query) => siteSearch("https://www.calpaktravel.com/search", query),
  "cabeau": (query) => siteSearch("https://cabeau.com/search", query),
};
...
const PRODUCT_CATALOG: CatalogProduct[] = [
  ...
  },
  {
    ...
    price: "$19",
    category: "personal",
    bankTags: ["skincare", "barrier-support", "daily-ritual", "wellness"],
    answerTags: ["practical", "comfort", "routine", "wellness"],
    priceTier: "budget",
    productUrl: "https://www.cerave.com/search?query=moisturizing%20cream",
    recommendationKind: "specific",
  },
  {
    brand: "The Ordinary",
    ...
    price: "$6",
    category: "personal",
    bankTags: ["serum", "skincare", "minimal", "results-led"],
    answerTags: ["minimal", "quality", "routine", "practical"],
    priceTier: "budget",
    productUrl: "https://theordinary.com/en-us/search?q=niacinamide%2010%25%20zinc%201%25",
    recommendationKind: "specific",
  },
  {
    brand: "Sol de Janeiro",
    name: "Brazilian Crush Cheirosa 62 Perfume Mist",
    price: "$25",
    category: "personal",
    bankTags: ["fragrance", "beauty", "feel-good", "signature-scent"],
    answerTags: ["luxurious", "trend", "beauty", "thoughtful"],
    priceTier: "mid-range",
    searchUrl: siteSearch("https://soldejaneiro.com/search", "Cheirosa 62 perfume mist"),
    recommendationKind: "generic",
  },
  {
    brand: "Philips Sonicare",
    name: "ProtectiveClean 6100",
    price: "$99",
    category: "personal",
    bankTags: ["grooming", "wellness", "practical", "daily-upgrade"],
    answerTags: ["practical", "quality", "routine", "wellness"],
    priceTier: "mid-range",
    searchUrl: "https://www.usa.philips.com/c-w/search.html#q=ProtectiveClean%206100",
    recommendationKind: "generic",
  },
  {
    brand: "Uncommon Goods",
    name: "Birth Month Flower Grow Kit",
    price: "$38",
    category: "gifts",
    bankTags: ["thoughtful", "giftable", "personalized", "occasion"],
    answerTags: ["thoughtful", "events", "quality", "sentimental"],
    priceTier: "budget",
    searchUrl: siteSearch("https://www.uncommongoods.com/search", "birth month flower grow kit"),
    recommendationKind: "generic",
  },
  {
    brand: "UrbanStems",
    name: "Seasonal Signature Bouquet",
    price: "$75",
    category: "gifts",
    bankTags: ["flowers", "romantic", "giftable", "occasion"],
    answerTags: ["romantic", "thoughtful", "events", "elegant"],
    priceTier: "mid-range",
    searchUrl: siteSearch("https://urbanstems.com/search", "signature bouquet"),
    recommendationKind: "generic",
  },
  {
    brand: "Sugarfina",
    name: "Bento Box Candy Gift Set",
    price: "$32",
    category: "gifts",
    bankTags: ["gift-set", "treat", "playful", "occasion"],
    answerTags: ["fun", "events", "thoughtful", "trend"],
    priceTier: "budget",
    searchUrl: siteSearch("https://www.sugarfina.com/search", "bento box candy gift set"),
    recommendationKind: "generic",
  },
  {
    brand: "Etsy",
    ...
    price: "$24",
    category: "gifts",
    bankTags: ["custom", "personalized", "giftable", "small-upgrade"],
    answerTags: ["thoughtful", "personalized", "events", "practical"],
    priceTier: "budget",
    searchUrl: siteSearch("https://www.etsy.com/search", "custom name mug"),
    recommendationKind: "generic",
  },
  {
    brand: "LEGO",
    name: "Botanicals Tiny Plants",
    price: "$49",
    category: "entertainment",
    bankTags: ["creative", "collectible", "weekend", "playful"],
    answerTags: ["creative", "weekend", "fun", "staying-in"],
    priceTier: "budget",
    productUrl: "https://www.lego.com/en-us/search?q=tiny%20plants",
    recommendationKind: "specific",
  },
  {
    brand: "Barnes & Noble",
    name: "BookTok Favorites Collection",
    price: "$29",
    category: "entertainment",
    bankTags: ["books", "reading", "curated", "cozy"],
    answerTags: ["books", "staying-in", "thoughtful", "weekend"],
    priceTier: "budget",
    searchUrl: siteSearch("https://www.barnesandnoble.com/s/", "booktok favorites"),
    recommendationKind: "generic",
  },
  {
    brand: "Target",
    name: "Party Board Game Pick",
    price: "$25",
    category: "entertainment",
    bankTags: ["board-game", "social", "hosting", "weekend"],
    answerTags: ["fun", "events", "weekend", "social"],
    priceTier: "budget",
    searchUrl: siteSearch("https://www.target.com/s", "party board game"),
    recommendationKind: "generic",
  },
  {
    brand: "LEGO",
    name: "Icons Polaroid OneStep SX-70 Camera",
    price: "$80",
    category: "entertainment",
    bankTags: ["nostalgic", "creative", "collectible", "display"],
    answerTags: ["creative", "trend", "quality", "weekend"],
    priceTier: "mid-range",
    searchUrl: siteSearch("https://www.lego.com/en-us/search", "Polaroid OneStep SX-70"),
    recommendationKind: "generic",
  },
  {
    brand: "Away",
    ...
    price: "$195",
    category: "travel",
    bankTags: ["travel", "weekender", "organized", "carry-on"],
    answerTags: ["traveling", "quality", "practical", "events"],
    priceTier: "premium",
    productUrl: "https://www.awaytravel.com/search?q=The%20Everywhere%20Bag",
    recommendationKind: "specific",
  },
  {
    brand: "Baggu",
    ...
    price: "$36",
    category: "travel",
    bankTags: ["packing", "organized", "travel", "lightweight"],
    answerTags: ["traveling", "practical", "routine", "quality"],
    priceTier: "budget",
    searchUrl: siteSearch("https://www.baggu.com/search", "packing cube set"),
    recommendationKind: "generic",
  },
  {
    brand: "Calpak",
    ...
    price: "$128",
    category: "travel",
    bankTags: ["weekender", "organized", "travel", "carry-on"],
    answerTags: ["traveling", "quality", "events", "comfort"],
    priceTier: "premium",
    searchUrl: siteSearch("https://www.calpaktravel.com/search", "Luka Duffel"),
    recommendationKind: "generic",
  },
  {
    brand: "Cabeau",
    ...
    price: "$44",
    category: "travel",
    bankTags: ["travel", "comfort", "flight", "wellness"],
    answerTags: ["traveling", "comfort", "practical", "wellness"],
    priceTier: "budget",
    searchUrl: siteSearch("https://cabeau.com/search", "Evolution S3 travel pillow"),
    recommendationKind: "generic",
  },
];
...
const CATEGORY_TARGETS: Record<RecommendationCategory, string[]> = {
  ...
  personal: ["purchase-values", "aesthetic-lean", "gift-preference"],
  gifts: ["gift-preference", "purchase-values", "free-time"],
  entertainment: ["free-time", "gift-preference", "daily-vibe"],
  travel: ["free-time", "gift-preference", "purchase-values"],
};
...
export const getCatalogRecommendations = (
  ...
  const byCategory = RECOMMENDATION_CATEGORY_ORDER.flatMap((category) => {
