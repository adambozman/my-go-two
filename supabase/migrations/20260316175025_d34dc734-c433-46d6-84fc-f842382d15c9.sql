...
DROP POLICY IF EXISTS "Users can view own weekly recommendations" ON public.weekly_recommendations;
...
DROP POLICY IF EXISTS "Users can insert own weekly recommendations" ON public.weekly_recommendations;
...
DROP POLICY IF EXISTS "Users can update own weekly recommendations" ON public.weekly_recommendations;
...
DROP POLICY IF EXISTS "Users can delete own weekly recommendations" ON public.weekly_recommendations;
...
CREATE INDEX IF NOT EXISTS idx_weekly_recommendations_user_week_start
