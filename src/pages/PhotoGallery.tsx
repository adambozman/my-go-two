...
const sections: Record<string, Section[]> = {
  ...
  categories: [
    ...
    { title: "Female Categories", photos: [
  ...
  templates: [
    ...
    { title: "Neutral Templates", photos: [
    ...
    { title: "Shared Templates (All Genders)", photos: [
  ...
  other: [
    ...
    { title: "Background Previews", photos: [
  ...
  byPage: [
    ...
    { title: "Onboarding (Style Cards)", photos: [
      { label: "male/minimal", src: maleMinimal, path: "styles/male/minimal.jpg" },
      { label: "male/classic", src: maleClassic, path: "styles/male/classic.jpg" },
      { label: "male/sporty", src: maleSporty, path: "styles/male/sporty.jpg" },
      { label: "male/trendy", src: maleTrendy, path: "styles/male/trendy.jpg" },
      { label: "male/edgy", src: maleEdgy, path: "styles/male/edgy.jpg" },
      { label: "male/boho", src: maleBoho, path: "styles/male/boho.jpg" },
      { label: "male/luxury", src: maleLuxury, path: "styles/male/luxury.jpg" },
      { label: "male/laid-back", src: maleLaidBack, path: "styles/male/laid-back.jpg" },
      { label: "female/minimal", src: femaleMinimal, path: "styles/female/minimal.jpg" },
      { label: "female/classic", src: femaleClassic, path: "styles/female/classic.jpg" },
      { label: "female/sporty", src: femaleSporty, path: "styles/female/sporty.jpg" },
      { label: "female/trendy", src: femaleTrendy, path: "styles/female/trendy.jpg" },
      { label: "female/edgy", src: femaleEdgy, path: "styles/female/edgy.jpg" },
      { label: "female/boho", src: femaleBoho, path: "styles/female/boho.jpg" },
      { label: "female/luxury", src: femaleLuxury, path: "styles/female/luxury.jpg" },
      { label: "female/laid-back", src: femaleLaidBack, path: "styles/female/laid-back.jpg" },
    ]},
    { title: "Onboarding (Category Covers)", photos: [
      { label: "male/shopping", src: maleShopping, path: "categories/male/shopping.jpg" },
      { label: "male/style", src: maleStyleCat, path: "categories/male/style.jpg" },
      { label: "male/food", src: maleFood, path: "categories/male/food.jpg" },
      { label: "male/gifts", src: maleGifts, path: "categories/male/gifts.jpg" },
      { label: "male/lifestyle", src: maleLifestyle, path: "categories/male/lifestyle.jpg" },
      { label: "male/fit", src: maleFitCat, path: "categories/male/fit.jpg" },
      { label: "female/shopping", src: femaleShopping, path: "categories/female/shopping.jpg" },
      { label: "female/style", src: femaleStyleCat, path: "categories/female/style.jpg" },
      { label: "female/food", src: femaleFood, path: "categories/female/food.jpg" },
      { label: "female/gifts", src: femaleGifts, path: "categories/female/gifts.jpg" },
      { label: "female/lifestyle", src: femaleLifestyle, path: "categories/female/lifestyle.jpg" },
      { label: "female/fit", src: femaleFitCat, path: "categories/female/fit.jpg" },
    ]},
    { title: "Questionnaires Page", photos: [
      { label: "brand-preferences", src: imgBrandPreferences, path: "templates/brand-preferences.jpg" },
      { label: "love-language", src: imgLoveLanguage, path: "templates/love-language.jpg" },
      { label: "pet-peeves", src: imgPetPeeves, path: "templates/pet-peeves.jpg" },
      { label: "specific-products", src: imgSpecificProducts, path: "templates/specific-products.jpg" },
    ]},
    { title: "MyGoTwo / Connection (Templates Male)", photos: [
      { label: "male/shoe-size", src: maleShoeSize, path: "templates/male/shoe-size.jpg" },
      { label: "male/shoe-sneakers", src: maleShoeSneakers, path: "templates/male/shoe-sneakers.jpg" },
      { label: "male/shoe-boots", src: maleShoeBoots, path: "templates/male/shoe-boots.jpg" },
      { label: "male/shoe-sandals", src: maleShoeSandals, path: "templates/male/shoe-sandals.jpg" },
      { label: "male/clothing-tops", src: maleClothingTops, path: "templates/male/clothing-tops.jpg" },
      { label: "male/clothing-bottoms", src: maleClothingBottoms, path: "templates/male/clothing-bottoms.jpg" },
      { label: "male/clothing-outerwear", src: maleClothingOuterwear, path: "templates/male/clothing-outerwear.jpg" },
      { label: "male/clothing-activewear", src: maleClothingActivewear, path: "templates/male/clothing-activewear.jpg" },
      { label: "male/clothing-sizes", src: maleClothingSizes, path: "templates/male/clothing-sizes.jpg" },
      { label: "male/scents", src: maleScents, path: "templates/male/scents.jpg" },
      { label: "male/scent-cologne", src: maleScentCologne, path: "templates/male/scent-cologne.jpg" },
      { label: "male/scent-bodycare", src: maleScentBodycare, path: "templates/male/scent-bodycare.jpg" },
      { label: "male/grooming", src: maleGrooming, path: "templates/male/grooming.jpg" },
      { label: "male/grooming-hair", src: maleGroomingHair, path: "templates/male/grooming-hair.jpg" },
      { label: "male/grooming-skin", src: maleGroomingSkin, path: "templates/male/grooming-skin.jpg" },
      { label: "male/measurements", src: maleMeasurements, path: "templates/male/measurements.jpg" },
      { label: "male/measure-ring", src: maleMeasureRing, path: "templates/male/measure-ring.jpg" },
      { label: "male/fragrances", src: maleFragrances, path: "templates/male/fragrances.jpg" },
      { label: "male/jewelry", src: maleJewelry, path: "templates/male/jewelry.jpg" },
      { label: "male/jewelry-necklaces", src: maleJewelryNecklaces, path: "templates/male/jewelry-necklaces.jpg" },
      { label: "male/jewelry-bracelets", src: maleJewelryBracelets, path: "templates/male/jewelry-bracelets.jpg" },
      { label: "male/jewelry-watches", src: maleJewelryWatches, path: "templates/male/jewelry-watches.jpg" },
    ]},
    { title: "MyGoTwo / Connection (Templates Female)", photos: [
      { label: "clothing-sizes", src: femaleClothingSizes, path: "templates/clothing-sizes.jpg" },
      { label: "shoe-size", src: femaleShoeSize, path: "templates/shoe-size.jpg" },
      { label: "scents", src: femaleScents, path: "templates/scents.jpg" },
      { label: "grooming", src: femaleGrooming, path: "templates/grooming.jpg" },
    ...
    { title: "Shared Templates (Food, Dates, Events, Travel)", photos: [
      { label: "coffee-order", src: imgCoffeeOrder, path: "templates/coffee-order.jpg" },
      { label: "coffee-hot", src: imgCoffeeHot, path: "templates/coffee-hot.jpg" },
      { label: "coffee-iced", src: imgCoffeeIced, path: "templates/coffee-iced.jpg" },
      { label: "coffee-espresso", src: imgCoffeeEspresso, path: "templates/coffee-espresso.jpg" },
    ...
    { title: "Preferences Page (Neutral Styles)", photos: [
      { label: "polished", src: neutralPolished, path: "styles/polished.jpg" },
      { label: "casual", src: neutralCasual, path: "styles/casual.jpg" },
      { label: "creative", src: neutralCreative, path: "styles/creative.jpg" },
      { label: "professional", src: neutralProfessional, path: "styles/professional.jpg" },
    ...
    { title: "Stock Photos (Relationship Profiles)", photos: [
      { label: "partner-1", src: partner1, path: "stock/partner-1.jpg" },
      { label: "partner-2", src: partner2, path: "stock/partner-2.jpg" },
      { label: "partner-3", src: partner3, path: "stock/partner-3.jpg" },
      { label: "partner-4", src: partner4, path: "stock/partner-4.jpg" },
