...
const timelineSteps = [
  {
    ...
    description: "Quick signup, then tell us who you are. Your taste, your style, your non-negotiables.",
    accent: "coral" as const,
  },
  {
    step: "02",
    title: "AI Builds Your Profile",
    description: "Our AI reads between the lines — building a taste profile that actually knows you.",
  ...
  },
  {
    ...
    description: "Coffee order. Ring size. Favorite shampoo. Add it once, it's there forever.",
    accent: "coral" as const,
  },
  {
    step: "04",
    title: "Invite Your People",
    description: "Send a link. They connect instantly. Now everyone who matters actually knows you.",
    accent: "teal" as const,
  },
  {
    step: "05",
    title: "Control Who Sees What",
    description: "You control the access. Your partner sees one thing. Your mom sees another.",
    accent: "coral" as const,
  },
  {
    step: "06",
    title: "AI Powers Every Decision",
    description: "Gift ideas, date night picks, favorite stores — served up for whoever's shopping for you.",
    accent: "teal" as const,
    ai: true,
  },
];
  ...
  return (
    <div className="landing-page min-h-screen overflow-hidden">
      <div className="relative z-10">
        ...
        {/* ═══ HERO ═══ */}
        <section style={{ padding: "64px 52px 72px" }} className="flex flex-col items-center text-center relative overflow-hidden">
          ...
          <motion.div {...riseIn(0.1)} className="flex flex-col items-center" style={{ gap: 4, marginBottom: 44 }}>
            ...
            <p style={{ marginTop: 10, fontSize: 13.5, fontWeight: 300, color: "#4a6068", letterSpacing: "0.2px", lineHeight: 1.6, maxWidth: 360, textAlign: "center" }}>
          ...
          <motion.div
            {...riseIn(0.24)}
            style={{ width: "100%", maxWidth: 560, aspectRatio: "16/9", marginBottom: 36, position: "relative", overflow: "hidden", background: "rgba(255,255,255,0.70)", border: "1px solid rgba(255,255,255,0.85)", borderRadius: 16, boxShadow: "0 8px 48px rgba(45,104,112,0.1), inset 0 1px 0 rgba(255,255,255,0.9)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}
          >
            <div style={{ position: "absolute", inset: 0, background: "linear-gradient(135deg, rgba(255,255,255,0.3) 0%, transparent 60%)", pointerEvents: "none" }} />
            <div
              style={{ width: 52, height: 52, borderRadius: "50%", background: "#d4543a", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 4px 24px rgba(212,84,58,0.38)", cursor: "pointer", transition: "transform 0.2s ease, box-shadow 0.2s ease", position: "relative", zIndex: 1 }}
              onMouseEnter={e => { e.currentTarget.style.transform = "scale(1.07)"; e.currentTarget.style.boxShadow = "0 8px 32px rgba(212,84,58,0.5)"; }}
              onMouseLeave={e => { e.currentTarget.style.transform = "scale(1)"; e.currentTarget.style.boxShadow = "0 4px 24px rgba(212,84,58,0.38)"; }}
            >
            ...
            <span style={{ fontSize: 11, letterSpacing: 2.5, textTransform: "uppercase", color: "#8a9ea4", fontWeight: 400, position: "relative", zIndex: 1, marginTop: 14 }}>
              See it in action
            </span>
          </motion.div>
          ...
          {/* Fine print */}
          <motion.p {...riseIn(0.36)} style={{ fontSize: 12, color: "#8a9ea4", fontWeight: 300, letterSpacing: "0.3px" }}>
        ...
        <section id="how-it-works" style={{ padding: "72px 0 56px" }}>
          ...
          <div className="relative" style={{ padding: "0 52px" }}>
            {/* Spine */}
            <div className="hidden md:block absolute top-0 bottom-0 left-1/2 w-px -translate-x-1/2" style={{ background: "linear-gradient(180deg, transparent 0%, rgba(45,104,112,0.2) 8%, rgba(45,104,112,0.2) 92%, transparent 100%)" }} />
            {/* Mobile spine */}
            <div className="md:hidden absolute top-0 bottom-0 left-[19px] w-px" style={{ background: "linear-gradient(180deg, transparent 0%, rgba(45,104,112,0.2) 8%, rgba(45,104,112,0.2) 92%, transparent 100%)" }} />
            ...
            <div className="space-y-11">
              {timelineSteps.map((step, i) => {
                ...
                const nodeStyle = {
                  ...
                  boxShadow: isCoral ? "0 3px 14px rgba(212,84,58,0.35)" : "0 3px 14px rgba(45,104,112,0.35)",
                ...
                return (
                  ...
                  >
                    ...
                    {/* Mobile */}
                    <div className="md:hidden flex" style={{ gap: 16 }}>
          ...
          >
            ...
            <div className="relative z-10">
              <div style={{ display: "flex", alignItems: "baseline", justifyContent: "center", gap: 3, marginBottom: 22 }}>
                <span style={{ fontFamily: "'Dancing Script', cursive", fontWeight: 600, fontSize: 34, color: "#d4543a", lineHeight: 1 }}>Go</span>
                <span style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 600, fontSize: 44, color: "white", lineHeight: 1 }}>Two</span>
              </div>

              <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 34, fontWeight: 600, color: "white", lineHeight: 1.2, marginBottom: 12 }}>
                Ready to get it right,<br />every single time?
              </h2>
