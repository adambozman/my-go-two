            ...
            {[
              ...
              if (item.type === "feature") {
                return (
                  ...
                  >
                    <div style={{ display: "flex", flexDirection: "column", height: "100%", textAlign: "center", padding: "24px 20px" }}>
                      <p style={{ fontSize: 9, letterSpacing: "0.2em", textTransform: "uppercase", color: "rgba(255,255,255,0.7)", fontFamily: "'Jost', sans-serif", fontWeight: 700, margin: "0 0 16px" }}>This or That</p>
                      <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 10 }}>
                        ...
                        <p style={{ fontSize: 13, color: "rgba(255,255,255,0.85)", fontFamily: "'Jost', sans-serif", margin: 0 }}>Two Options. One Choice.</p>
                        <p style={{ fontSize: 13, color: "rgba(255,255,255,0.85)", fontFamily: "'Jost', sans-serif", margin: 0 }}>Your Pattern Builds Over Time.</p>
                        <p style={{ fontSize: 12, color: "rgba(255,255,255,0.6)", fontFamily: "'Jost', sans-serif", margin: "8px 0 0" }}>Help the AI learn your vibe.</p>
                      </div>
                    </div>
                  </motion.div>
                );
