            ...
            {[
              ...
              if (item.type === "feature") {
                return (
                  ...
                  >
                    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "flex-start", height: "100%", textAlign: "center", gap: 12, padding: "20px" }}>
                      ...
                      <p style={{ fontSize: 13, color: "rgba(255,255,255,0.6)", fontFamily: "'Jost', sans-serif", margin: "8px 0 0" }}>Help the AI learn your vibe.</p>
                    </div>
                  </motion.div>
                );
              }
