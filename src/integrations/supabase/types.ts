...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      this_or_that_v2_answer_signals: {
        Row: {
          answer_id: string
          brand: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "this_or_that_v2_answer_signals_answer_id_fkey"
            columns: ["answer_id"]
            isOneToOne: false
            referencedRelation: "this_or_that_v2_answers"
            referencedColumns: ["id"]
          },
        ]
      }
      this_or_that_v2_answers: {
        Row: {
          answer_payload: Json
          answered_at: string
          brand: string | null
          ...
          question_key: string
          recommendation_category: string | null
          rejected_option_id: string | null
          rejected_option_key: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "this_or_that_v2_answers_question_id_fkey"
            columns: ["question_id"]
            isOneToOne: false
            referencedRelation: "this_or_that_v2_questions"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "this_or_that_v2_answers_rejected_option_id_fkey"
            columns: ["rejected_option_id"]
            isOneToOne: false
            referencedRelation: "this_or_that_v2_options"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "this_or_that_v2_answers_selected_option_id_fkey"
      ...
      this_or_that_v2_options: {
        ...
        Relationships: [
          {
            foreignKeyName: "this_or_that_v2_options_question_id_fkey"
            columns: ["question_id"]
            isOneToOne: false
            referencedRelation: "this_or_that_v2_questions"
            referencedColumns: ["id"]
