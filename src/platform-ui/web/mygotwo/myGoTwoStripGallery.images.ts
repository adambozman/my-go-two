...
const STRIP_LAYOUT: StripLayout[] = [
  ...
  { id: "04", align: "54%" },
  { id: "05", align: "62%", label: "My Vault", categorySlug: "vault" },
  { id: "06", align: "48%" },
  { id: "07", align: "46%", label: "Wishlist", categorySlug: "wishlist" },
  { id: "08", align: "58%" },
  { id: "09", align: "29%", label: "Dining & Beverages", categorySlug: "dining" },
  { id: "10", align: "61%" },
  { id: "11", align: "41%", label: "Health", categorySlug: "health" },
  { id: "12", align: "35%" },
