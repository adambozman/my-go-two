...
export const WEB_MYGOTWO_STAGE_CLASS =
  "h-full overflow-y-auto overflow-x-hidden snap-y snap-mandatory relative";
...
export const WEB_MYGOTWO_STAGE_SHELL_CLASS =
  "flex h-full w-full flex-col items-center justify-start pt-[calc(18px+var(--coverflow-desktop-y-offset))]";
