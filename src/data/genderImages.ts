...
const styleImages: Record<string, Record<string, string>> = {
  ...
  polished: { male: neutralPolished, female: neutralPolished, neutral: neutralPolished },
  casual: { male: neutralCasual, female: neutralCasual, neutral: neutralCasual },
  athletic: { male: maleSporty, female: femaleSporty, neutral: neutralSporty },
  creative: { male: neutralCreative, female: neutralCreative, neutral: neutralCreative },
  professional: { male: neutralProfessional, female: neutralProfessional, neutral: neutralProfessional },
  chill: { male: neutralChill, female: neutralChill, neutral: neutralChill },
