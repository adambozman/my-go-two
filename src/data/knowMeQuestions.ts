...
export const THIS_OR_THAT: ThisOrThatItem[] = [
  ...
  /* ── FOOD & DRINK (15) ── */
  { id: "tot-43", prompt: "Sushi over pizza?", category: "Food", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-44", prompt: "Do you like Chick-fil-A?", category: "Food", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-45", prompt: "Are you a Starbucks person?", category: "Food", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-46", prompt: "Would you try street food abroad?", category: "Food", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-47", prompt: "Do you like spicy food?", category: "Food", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-48", prompt: "Are you a wine person?", category: "Food", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-49", prompt: "Tacos over burgers?", category: "Food", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-50", prompt: "Do you like craft beer?", category: "Food", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-51", prompt: "Would you eat at a Michelin restaurant?", category: "Food", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-52", prompt: "Are you a breakfast person?", category: "Food", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-53", prompt: "Do you like Thai food?", category: "Food", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-54", prompt: "Coffee over tea — always?", category: "Food", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-55", prompt: "Would you go vegan for a month?", category: "Food", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-56", prompt: "Do you like Indian food?", category: "Food", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-57", prompt: "Chocolate over vanilla?", category: "Food", image: "", optionA: "Yes", optionB: "No" },

  /* ── STYLE & AESTHETICS (10) ── */
  { id: "tot-58", prompt: "Minimalist over maximalist?", category: "Style", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-59", prompt: "Gold jewelry over silver?", category: "Style", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-60", prompt: "Sneakers over dress shoes?", category: "Style", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-61", prompt: "Do you prefer vintage over brand new?", category: "Style", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-62", prompt: "All black everything?", category: "Style", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-63", prompt: "Do you follow fashion trends?", category: "Style", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-64", prompt: "Would you wear bold patterns?", category: "Style", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-65", prompt: "Comfort over style — always?", category: "Style", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-66", prompt: "Do you accessorize?", category: "Style", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-67", prompt: "Would you wear a statement watch?", category: "Style", image: "", optionA: "Yes", optionB: "No" },

  /* ── PLACES & TRAVEL (13) ── */
  { id: "tot-68", prompt: "Beach over mountains?", category: "Places", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-69", prompt: "Would you visit Tokyo?", category: "Places", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-70", prompt: "Paris or New York?", category: "Places", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-71", prompt: "Would you go on a cruise?", category: "Places", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-72", prompt: "Do you prefer city trips?", category: "Places", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-73", prompt: "Would you backpack through Europe?", category: "Places", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-74", prompt: "All-inclusive resort vibe?", category: "Places", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-75", prompt: "Would you live abroad for a year?", category: "Places", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-76", prompt: "Cabin in the woods getaway?", category: "Places", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-77", prompt: "Would you visit Iceland?", category: "Places", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-78", prompt: "Do you like camping?", category: "Places", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-79", prompt: "Would you do a safari?", category: "Places", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-80", prompt: "Tropical island honeymoon?", category: "Places", image: "", optionA: "Yes", optionB: "No" },

  /* ── DATE IDEAS (10) ── */
  { id: "tot-81", prompt: "Dinner and a movie for a first date?", category: "Date Ideas", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-82", prompt: "Picnic in the park?", category: "Date Ideas", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-83", prompt: "Cooking together at home?", category: "Date Ideas", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-84", prompt: "A surprise weekend getaway?", category: "Date Ideas", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-85", prompt: "Wine tasting date?", category: "Date Ideas", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-86", prompt: "Escape room together?", category: "Date Ideas", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-87", prompt: "Spa day for two?", category: "Date Ideas", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-88", prompt: "Concerts as a couple?", category: "Date Ideas", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-89", prompt: "Hiking date?", category: "Date Ideas", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-90", prompt: "Game night at home?", category: "Date Ideas", image: "", optionA: "Yes", optionB: "No" },

  /* ── LIFESTYLE & SPENDING (10) ── */
  { id: "tot-91", prompt: "Would you spend $100 on a t-shirt?", category: "Spending", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-92", prompt: "Worth it: $50 candle?", category: "Spending", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-93", prompt: "Would you pay $200+ for sneakers?", category: "Spending", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-94", prompt: "Splurge on designer sunglasses?", category: "Spending", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-95", prompt: "Dog person?", category: "Lifestyle", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-96", prompt: "Are you spontaneous?", category: "Lifestyle", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-97", prompt: "Netflix night over going out?", category: "Lifestyle", image: "", optionA: "Yes", optionB: "No" },
  { id: "tot-98", prompt: "Brunch over dinner?", category: "Lifestyle", image: "", optionA: "Yes", optionB: "No" },
